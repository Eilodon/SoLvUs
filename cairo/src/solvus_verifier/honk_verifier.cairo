...
use super::honk_verifier_circuits::{run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_17_PUB_23_circuit, run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_17_circuit, run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_17_circuit, run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_17_circuit, run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_17_circuit, is_on_curve_excluding_infinity_bn254};
...
mod UltraKeccakZKHonkVerifier {
    ...
    use super::{vk, precomputed_lines, run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_17_PUB_23_circuit, run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_17_circuit, run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_17_circuit, run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_17_circuit, run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_17_circuit, is_on_curve_excluding_infinity_bn254};
    ...
    impl IUltraKeccakZKHonkVerifier of super::IUltraKeccakZKHonkVerifier<ContractState> {
        fn verify_ultra_keccak_zk_honk_proof(
            ...
            let (mut challenge_poly_eval, mut root_power_times_tp_gemini_r) = run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_17_circuit(
                tp_gemini_r: transcript.gemini_r.into(),
                modulus: mod_grumpkin,
            );
            for i in 0..vk.log_circuit_size {
                let (new_challenge_poly_eval, new_root_power_times_tp_gemini_r) = run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_17_circuit(
            ...
            let (vanishing_check, diff_check) = run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_17_circuit(
...
full_proof.proof.lookup_read_tags.into(), // Proof point 9
            ...
            for point in points.slice(28, 29) {
                assert(is_on_curve_excluding_infinity_bn254(*point, mod_bn), 'proof point not on curve');
            };

            // Assert shplonk_q is on curve
            let shplonk_q_pt:G1Point = full_proof.proof.shplonk_q.into();
            assert(is_on_curve_excluding_infinity_bn254(shplonk_q_pt, mod_bn), 'shplonk_q not on curve');
